...
import VolcEnhanceConfig from "../../../components/VolcEnhanceConfig";

export default function SettingsPage() {
  const router = useRouter();
  const [tab, setTab] = useState<"accounts" | "models" | "upscale">("accounts");
    ...
    <div className="page-enter">
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 24 }}>
        ...
        <button
          ...
          style={{
            color: tab === "upscale" ? "var(--accent)" : undefined,
            borderColor: tab === "upscale" ? "var(--border-focus)" : undefined,
            background: tab === "upscale" ? "var(--accent-glow)" : undefined,
          }}
        >
          画质提升
        </button>
